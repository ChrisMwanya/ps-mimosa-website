      ...
      <div className="max-w-4xl mx-auto px-4 text-center">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground mb-10 leading-relaxed">
            Nous ne prêchons pas une religion, mais une relation. Jésus-Christ est l'espoir de l'humanité, le seul capable de restaurer, de pardonner et de donner un sens véritable à notre existence. Peu importe votre passé, il y a de la grâce pour votre présent et de l'espoir pour votre futur.
          </p>
          <Link 
            href="#about" 
